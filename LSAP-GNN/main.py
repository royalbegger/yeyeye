...
def start_train():
    ...
    for epoch in range(epochs):
        ...
        wandb.log({
            "epoch": epoch,
            "train_loss": epoch_total_loss / train_iters,
            "val_accuracy": eval_correct,
            "val_loss": eval_loss
        })
    ...
    wandb.save('trained_net_' + args.id + '.pth')  # 上传模型文件
    print('model saved')
...
if __name__ == '__main__':
    ...
    wandb.init(project="LSAP-GNN", name=f"exp_{args.id}", config=args)
